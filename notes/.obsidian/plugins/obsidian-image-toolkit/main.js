...
function t(str) {
  if (!locale) {
    console.error(
      "Error: Image toolkit locale not found",
...
class ImageToolkitSettingTab extends obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.pinMode).onChange((value) =>
          __awaiter(this, void 0, void 0, function* () {
        ...
        slider
          ...
          .onChange((value) =>
            __awaiter(this, void 0, void 0, function* () {
              ...
              (_a = this.plugin.containerView) === null || _a === void 0
                ? void 0
                : _a.setPinMaximum(value);
  ...
  setAndSavePickrSetting(name, savedColor) {
    ...
    if ("GALLERY_NAVBAR_DEFAULT_COLOR_NAME" === name) {
      ...
      (_a = this.plugin.containerView) === null || _a === void 0
        ? void 0
        : _a.setImgViewDefaultBackgroundForImgList();
    }
    this.plugin.saveSettings();
  }
  getDropdownOptions() {
...
class ContainerView {
  constructor(plugin, containerType, pinMaximum) {
    ...
    this.removeOitContainerView = () => {
      ...
      (_a = this.imgInfoCto.oitContainerViewEl) === null || _a === void 0
        ? void 0
        : _a.remove();
    ...
    this.checkStatus = () => {
      ...
      if (this.imgInfoCto.oitContainerViewEl) {
        const containerElList = document.getElementsByClassName(
    ...
    this.showPlayerImg = (activeImg) => {
      ...
      this.imgInfoCto.imgPlayerEl.addEventListener(
        "click",
        this.closePlayerImg
      );
      const windowWidth =
    ...
    this.closePlayerImg = () => {
      ...
      if (this.imgInfoCto.imgPlayerEl) {
        ...
        this.imgInfoCto.imgPlayerEl.removeEventListener(
          "click",
          this.closePlayerImg
        );
      }
  ...
  constructor(plugin, containerType) {
    ...
    this.initContainerViewDom = (containerEl) => {
      ...
      if (!this.imgInfoCto.oitContainerViewEl) {
        ...
        containerEl.appendChild(
          (this.imgInfoCto.oitContainerViewEl = createDiv(
    ...
    this.closeContainerView = (event, activeImg) => {
      if (event) {
        ...
        if (
          "img-container" != targetClassName &&
          "oit-main-container-view" != targetClassName
        )
          return;
      }
      if (!activeImg && !(activeImg = this.imgGlobalStatus.activeImg)) return;
    ...
    this.renderImgTitle = (name, index) => {
      ...
      if (undefined !== name && null !== name)
        (_a = this.imgInfoCto.imgTitleNameEl) === null || _a === void 0
          ? void 0
          : _a.setText(name);
      if (undefined !== index && null !== index)
        (_b = this.imgInfoCto.imgTitleIndexEl) === null || _b === void 0
          ? void 0
          : _b.setText(" " + index);
    };
    this.switchImageOnGalleryNavBar = (event, next) => {
  ...
  constructor() {
    ...
    this.clickImage = (event) => {
      ...
      if (
        ...
        !this.containerView.checkHotkeySettings(
          event,
          this.settings.viewTriggerHotkey
        )
      )
        return;
